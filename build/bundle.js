...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppJs = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(97)('socket.io-client');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(97)('socket.io-client:url');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var object = __webpack_require__(146);
	var debug = __webpack_require__(97)('socket.io-client:manager');
	var indexOf = __webpack_require__(147);
	var Backoff = __webpack_require__(148);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(98);
	var bind = __webpack_require__(145);
	var debug = __webpack_require__(97)('socket.io-client:socket');
	var hasBin = __webpack_require__(150);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SyntheticCompositionEvent = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(97)('socket.io-parser');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	  function App() {
	    ...
	    _socket2['default'].on('connectSuccess', function (data) {
	      _this2.setState({
	        connections: data.connections
	      });
	    });

	    _socket2['default'].on('disconnectedUser', function (data) {
	      _this2.setState({
	        connections: data.connections
	      });
	    });

	    _socket2['default'].on('buttonTime', function (data) {
	      _this2.setState({
	        buttonTime: data.buttonTime,
	        status: _this2.status(data.buttonTime),
	  ...
	  _createClass(App, [{
	    ...
	    value: function pushButton() {
	      _socket2['default'].emit('buttonPush', 'pushButton', function (data) {
	        console.log(data);
	      });
	    }
	  }, {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            null,
	            '# of People That can press button: ',
	            this.state.connections
	          ),
	          _react2['default'].createElement(
	            'a',
	            { href: '#', style: style.button[this.state.status], onClick: this.pushButton },
	            'Button'
	          ),
	          _react2['default'].createElement(
	            'h2',
	          ...
	          this.state.frick ? _react2['default'].createElement('img', { src: 'http://media.giphy.com/media/13aSSyJaI5NkTm/giphy.gif' }) : null
	        )
	      );
	    }
	  }]);
	...
	var fontFamily = '"HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif';
